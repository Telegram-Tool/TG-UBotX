...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "Yesمرحبا أيها الغريب! إذا كنت تشاهد هذه الرسالة التي "
    "Yesيعني أنني لم أوافق على رسالتك الخاصة بعد. إذا كنت سوف تعرف "
    "Yesلكم هذا لا يشكل مشكلة، فقط انتظر قليلا ل "
    "Yesلي لقراءة رسائلك الخاصة بي والموافقة لك. إذا كنت لا "
    "Yesأعلم أنك يرجى الرجوع إلى أي المجموعة التي وجدت لي "
    "Yesفي وإزالة نفسك قبل أن يقدم لك 😁")
# =================================================================
